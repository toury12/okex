okex
====
[![Go Reference](https://pkg.go.dev/badge/github.com/toury/okex.svg)](https://pkg.go.dev/github.com/amir-the-h/okex)
...
[![CI](https://github.com/toury/okex/actions/workflows/main.yml/badge.svg)](https://github.com/toury/okex/actions/workflows/main.yml)
[![CodeQL](https://github.com/toury/okex/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/amir-the-h/okex/actions/workflows/codeql-analysis.yml)
[![AutoRelease](https://github.com/toury/okex/actions/workflows/release.yml/badge.svg)](https://github.com/toury/okex/actions/workflows/release.yml)
...
```bash
go get github.com/toury/okex@v1.0.28-alpha
```
...
import (
	...
	ws_private_requests "github.com/toury/okex/requests/ws/private"
	ws_public_requests "github.com/toury/okex/requests/ws/public"
	"log"
)
...
* To receive websocket events you can choose [RawEventChan](/api/ws/client.go#L25)
  ...
  channels. [More info](https://github.com/toury/okex/wiki/Handling-WS-events) 
